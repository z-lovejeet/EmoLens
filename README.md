...
**Copyright © 2026 Lovejeet Singh. All Rights Reserved.**

This repository and its source code, designs, and assets are proprietary. No portion of this software may be copied, reproduced, modified, distributed, deployed, or commercially used without prior express written permission from the author. See the [LICENSE](LICENSE) file for full legal terms.
